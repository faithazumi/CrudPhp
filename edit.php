...
<div class="container">
    ...
    if (isset($_POST['update'])) {
        ...
        if (
            ...
            echo "Anda harus mengisi form terlebih dahulu";
        } else {
            ...
            if ($con->query($sql) === TRUE) {
                echo "<div class=alert alert-success'>Berhasil merubah data siswa</div>";
            } else {
                echo "<div class=alert alert-danger'>Error: Ada kesalahan saat merubah data siswa</div>";
            }
        }
    }
